	...
	function checkIfExistsIn(on,bot,leftOff,bottOff,height,width,startSrc,startDst,endSrc,endDst){
		...
		if(((b1==0)||(b2==0)||(b1==-1&&b2==1))&&((b4==0)||(b5==0)||(b4==-1&&b5==1))){
			...
			if(b1==0){
				...
				if(b2==0){
					var temp=PxToInt(on.style.width);
					if(temp-PxToInt(bot.style.width)<=2&&temp>=PxToInt(bot.style.width)&&
							((bot.className).toString()=="splitDIVofoghi"||(bot.className).toString()=="splitDIVamoodi"))
						temp-=innerSplitOffsetWidth;
					width.push(temp);
			...
			if(b4==0){
				...
				if(b5==0){
					var temp=PxToInt(on.style.height);
					if(temp-PxToInt(bot.style.height)<=2&&temp>=PxToInt(bot.style.height)&&
							((bot.className).toString()=="splitDIVofoghi"||(bot.className).toString()=="splitDIVamoodi"))
						temp-=innerSplitOffsetHeight;
					height.push(temp);
//					alert(outerHeight(on)+" "+on.style.height);
//					height.push(outerHeight(on));
					endSrc.push(on.endSrc);
				}
				else{
					var temp=PxToInt(bot.style.height)-PxToInt(bot.style.bottom)+PxToInt(on.style.bottom);
					
//					temp+=innerSplitOffsetHeight/2;
					height.push(temp);
				...
				if(b5==1){
					var temp=PxToInt(bot.style.height);
					height.push(temp);
					endSrc.push(bot.endSrc);
//					alert(height+" "+bot.style.height+" "+width+" "+bot.style.width);
				}
				else if(b5==0){
					height.push(PxToInt(on.style.height)-(PxToInt(bot.style.bottom)-PxToInt(on.style.bottom))+innerSplitOffsetHeight);
					endSrc.push(on.endSrc);
				}
			}
//			alert(height+" "+bot.style.height+" "+width+" "+bot.style.width);
